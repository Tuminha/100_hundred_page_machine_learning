...
*   **Notation:** Understanding symbols like Σ (summation) and Π (product) and their applications (e.g., calculating Sum of Squared Errors - SSE, or joint probabilities). See `chapter_2_foundations/notation_examples.py`, `chapter_2_foundations/sigma_notation_sse.py`, and `chapter_2_foundations/pi_notation_joint_prob.py` for practical examples.
