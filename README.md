...
*   **Notation:** Understanding symbols like Σ (summation), Π (product), and set operations (∈, ∉, ∪, ∩, ⊆, ...) and their applications. See `chapter_2_foundations/notation_examples.py`, `chapter_2_foundations/sigma_notation_sse.py`, `chapter_2_foundations/pi_notation_joint_prob.py`, and `chapter_2_foundations/set_operations_demo.py` for practical examples and visualizations.
